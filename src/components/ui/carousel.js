...
const CarouselControl = ({ type, title, handleClick }) => {
  return (
    <button
      className={`w-8 h-8 flex items-center mx-1 justify-center bg-neutral-200 dark:bg-neutral-800 border-3 border-transparent rounded-full focus:border-[#6D64F7] focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${
...
export function Carousel({ slides }) {
  ...
  return (
    <div className="relative w-[50vmin] h-[50vmin] mx-auto" aria-labelledby={`carousel-heading-${id}`}>
      <ul
      ...
      <div className="absolute flex justify-center w-full top-[calc(100%+0.5rem)] mt-8">
